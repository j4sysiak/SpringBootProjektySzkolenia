...
public class Application_CreateData {
	...
	public static void main(String[] args) {
		...
		try {	
			...
			tmpBank.setAddressLine1("hhhhhhhhhhhhhhhhhh");
			tmpBank.setAddressLine2("rrrrrrrrrrrrrrrrrrrrrr");
			tmpBank.setCity("New York");
			tmpBank.setState("NY");
			tmpBank.setZipCode("78-90-99");
			tmpBank.getContacts().add("Jacek");
			tmpBank.getContacts().add("Maria");
			tmpBank.getContacts().add("Ewa");
