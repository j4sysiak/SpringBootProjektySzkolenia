...
//	}
	...
	public void testSaveAndDeleteInterest() throws Exception {
		...
		// trzeba wyczyscic baze myFirstDB_test (delete all tabeles)
		// zrobic przebieg zakładajacy tabele - we wszestkich klsach testowych @Transactional musi być odkomentowany
